      ...
      React.createElement('div', { className: 'p-6 md:p-8' },
        ...
        React.createElement('div', { className: 'mt-6 pt-5 border-t border-slate-100' },
          React.createElement('div', { className: 'flex items-center gap-2 mb-3' },
            React.createElement(Users, { className: 'w-3.5 h-3.5 text-slate-400' }),
            React.createElement('p', { className: 'text-xs font-bold uppercase tracking-wider text-slate-400' }, 'Clinical Team')
          ),
          React.createElement('div', { className: 'grid grid-cols-2 gap-x-4 gap-y-1' },
            PROVIDERS.map((p, i) =>
              React.createElement('span', { key: i, className: 'text-xs text-slate-500' }, p)
            )
          )
        )
      )
