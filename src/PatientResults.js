        ...
        e('div', { className: 'flex-1 min-w-0' },
          ...
          psadNum != null && e('p', { className: 'text-xs mt-2 leading-snug', style: { color: colors.text, opacity: 0.85 } },
            ...
            psadNum < MV.basic_psad.youden_cutoff
              ? `below threshold (${MV.basic_psad.youden_cutoff}) · NPV ${(MV.basic_psad.npv_at_youden * 100).toFixed(0)}% in N=${MV.basic_psad.n_with_psad} cohort`
              : `above threshold (${MV.basic_psad.youden_cutoff}) · AUC ${MV.basic_psad.auc_internal} in N=${MV.basic_psad.n_with_psad} cohort`
          )
        )
      )
    ),
