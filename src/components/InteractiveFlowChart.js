...
export default function InteractiveFlowChart({ currentStep, stepHistory, onStepClick }) {
  const steps = {
    ...
    // Phase 2: Pre-Enrollment Verification (positioned below Phase 1)
    'pev_life_expectancy': { x: 200, y: 580, label: 'P2: Life\nExpectancy', width: 140, height: 60 },
    'pev_genomic_and_confirmatory_plan': { x: 200, y: 680, label: 'P2: Genomic\n& Biopsy Plan', width: 140, height: 60 },
    'pev_confirmatory_bx_result': { x: 200, y: 780, label: 'P2: Bx\nResult', width: 140, height: 60 },
    'pev_concerning_features_check': { x: 80, y: 880, label: 'P2: Concerning\nFeatures', width: 140, height: 60 },
    'pev_intensified_as_discussion': { x: 80, y: 980, label: 'P2: High-\nIntensity AS', width: 140, height: 60 },
    'pev_polyiclc_enrollment_decision': { x: 80, y: 1080, label: 'P2: Enroll\nPoly-ICLC?', width: 140, height: 60 },
    'pev_enroll_as_protocol': { x: 320, y: 880, label: 'Enroll\nAS', width: 120, height: 50 },
    'pev_end_high_intensity_as': { x: 80, y: 1200, label: 'High-\nIntensity AS\nDocumented', width: 140, height: 70 },
    'pev_end_watchful_waiting': { x: 320, y: 580, label: 'Watchful\nWaiting', width: 120, height: 50 }
  }
  ...
  const connections = [
    ...
    { from: 'pev_life_expectancy', to: 'pev_end_watchful_waiting', label: '≤10y', offset: 40 },
    ...
    { from: 'pev_confirmatory_bx_result', to: 'pev_concerning_features_check', label: 'Neg/G6', offset: -30 },
    ...
    { from: 'pev_polyiclc_enrollment_decision', to: 'pev_end_high_intensity_as', label: 'Yes/No', offset: 0 }
  ]
