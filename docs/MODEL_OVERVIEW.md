...
|---|---|---|
| **Guideline checklist** ("Basic" panel) — [`calcBasic`](../src/asEngine.js#L567) | Each input checked against a cited NCCN/EAU/literature threshold (e.g. PSAD > 0.15) | No — informational display only, does not feed the prediction or the tier |
| **Monitoring checklist** — [`calcMonitoring`](../src/asEngine.js#L945) | Counts how many risk features are present (PSAD high, PI-RADS ≥4, no MRI, etc.) | Partially — drives the surveillance-intensity tier shown to the clinician, unweighted |
| **`fullModel`** — [`calcUpgradeRisk`](../src/asEngine.js#L1586) | A logistic regression fit directly on the cohort's own outcomes | **Yes — this is the model** |
...
- **Coefficients defined at:** [`src/asEngine.js:1488–1517`](../src/asEngine.js#L1488) (`UPGRADE_RISK_MODEL.fullModel`)
- **Prediction logic at:** [`src/asEngine.js:1586`](../src/asEngine.js#L1586) (`calcUpgradeRisk`)

## Input variables (18 total)

| Variable | Type | Coefficient | Direction | Line |
|---|---|---|---|---|
| `first_positive_bx_ggg_named` (Grade Group) | ordinal (GG1/2/3) | −1.57 | **Largest effect.** Counterintuitive sign — see note below | [asEngine.js:1513](../src/asEngine.js#L1513) |
| `current_smoking_category` | categorical | −0.72 | | [asEngine.js:1506](../src/asEngine.js#L1506) |
| `race_category_2` | categorical | −0.61 | **Fixed to a constant reference value for every patient — see note below** | [asEngine.js:1505](../src/asEngine.js#L1505) |
| `fhx_ovarian_category` | categorical | −0.50 | | [asEngine.js:1511](../src/asEngine.js#L1511) |
| `fhx_breast_category` | categorical | +0.24 | | [asEngine.js:1510](../src/asEngine.js#L1510) |
| `ece_category` (extracapsular extension) | binary | +0.24 | | [asEngine.js:1514](../src/asEngine.js#L1514) |
| `hld_category` (hyperlipidemia) | categorical | −0.23 | | [asEngine.js:1508](../src/asEngine.js#L1508) |
| `diabetes_category` | categorical | +0.21 | | [asEngine.js:1509](../src/asEngine.js#L1509) |
| `psa_result_ng` | continuous | +0.021 | Higher PSA → higher risk | [asEngine.js:1503](../src/asEngine.js#L1503) |
| `total_positive_cores` | continuous | +0.057 | More positive cores → higher risk | [asEngine.js:1501](../src/asEngine.js#L1501) |
| `fhx_prostate_category` | categorical | −0.086 | | [asEngine.js:1512](../src/asEngine.js#L1512) |
| `as_mri_prostate_vol` | continuous | −0.016 | Larger prostate → lower risk (dilutes PSAD) | [asEngine.js:1504](../src/asEngine.js#L1504) |
| `highest_pirads_category` | categorical | +0.039 | | [asEngine.js:1516](../src/asEngine.js#L1516) |
| `abut_category` (NVB abutment) | binary | +0.031 | | [asEngine.js:1515](../src/asEngine.js#L1515) |
| `htn_category` (hypertension) | categorical | −0.026 | | [asEngine.js:1507](../src/asEngine.js#L1507) |
| `perc_highest_core_involvement...` | continuous | +0.0036 | | [asEngine.js:1502](../src/asEngine.js#L1502) |
| `bmi` | continuous | −0.0011 | | [asEngine.js:1499](../src/asEngine.js#L1499) |
| `age_first_diagnosis` | continuous | +0.013 | | [asEngine.js:1500](../src/asEngine.js#L1500) |
...
2. **Race is in the coefficient list but never actually varies per patient.** The code fixes
   ...
   [`src/asEngine.js:1674`](../src/asEngine.js#L1674) (`RACE_REFERENCE_OFFSET`) — kept only
...
estimate. The guideline checklist ([`calcBasic`](../src/asEngine.js#L567)) and monitoring
checklist ([`calcMonitoring`](../src/asEngine.js#L945)) remain useful for eligibility and
scheduling, but are not statistically predictive on their own — this is why
[`calcCombined`](../src/asEngine.js#L1061) no longer lets `calcBasic`'s output move the
...
- Missing-value imputation for the model's continuous fields (BMI, age, max-core%, PSA,
  ...
  [`src/asEngine.js:1623–1628`](../src/asEngine.js#L1623) — that are documented as
...
| What | File / line |
|---|---|
| The model's prediction path | [`src/asEngine.js:1586`](../src/asEngine.js#L1586) — `calcUpgradeRisk` |
| Coefficients and intercept | [`src/asEngine.js:1488–1517`](../src/asEngine.js#L1488) — `UPGRADE_RISK_MODEL.fullModel` |
| Guideline checklist (informational, not predictive) | [`src/asEngine.js:567`](../src/asEngine.js#L567) — `calcBasic` |
| Monitoring checklist / tier | [`src/asEngine.js:945`](../src/asEngine.js#L945) — `calcMonitoring` |
| How tiers combine | [`src/asEngine.js:1061`](../src/asEngine.js#L1061) — `calcCombined` |
