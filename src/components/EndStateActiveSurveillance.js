...
export default function EndStateActiveSurveillance({ onReset, pathSummary, onBack, canGoBack, onPrintChart, onContinuePart2 , patientId, patientData, endState }) {
  ...
  return React.createElement('div', { className: 'bg-white rounded-xl border border-slate-100 overflow-hidden', style: { boxShadow: '0 8px 40px -8px rgba(16,185,129,0.18)' } },
    ...
    React.createElement('div', {
      ...
      React.createElement('h2', { className: 'text-xl sm:text-2xl font-bold text-white mb-1' }, 'Active Surveillance Initiated'),
