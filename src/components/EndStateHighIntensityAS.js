...
export default function EndStateHighIntensityAS({ onReset, pathSummary, onBack, canGoBack , patientId, patientData, endState }) {
  ...
  return React.createElement('div', { className: 'bg-white rounded-xl border border-slate-100 overflow-hidden', style: { boxShadow: '0 8px 40px -8px rgba(33,32,112,0.2)' } },
    ...
    React.createElement('div', {
      ...
      React.createElement('h2', { className: 'text-xl sm:text-2xl font-bold text-white mb-1' }, 'High Intensity AS Protocol'),
