...
import { AlertTriangle, RotateCcw, Copy, FileImage, FileText, ArrowLeft } from 'lucide-react'

export default function EndStateDefinitiveTreatment({ onReset, pathSummary, onBack, canGoBack, onPrintChart }) {
